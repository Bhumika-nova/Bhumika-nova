...
- 🏃 **[Xtride](https://github.com/Bhumika-nova)** — Offline-first health and activity tracker with Jetpack Compose, Room Database local persistence, Google Fit API integration, and MPAndroidChart data visualization.
